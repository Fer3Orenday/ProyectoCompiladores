...
def p_error(p):
    if p:
        ...
        errores_sintacticos2.append(error_message)
...
def set_error_output(output_widget):
    parser2.error_output = output_widget

def get_sintactic_errors():
    return errores_sintacticos2

parser2 = yacc.yacc(errorlog=yacc.NullLogger())