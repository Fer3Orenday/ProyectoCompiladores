...
_lr_productions = [
  ...
  ('programa -> MAIN LBRACE lista_declaraciones RBRACE','programa',4,'p_programa','sint.py',42),
  ('lista_declaraciones -> lista_declaraciones declaracion','lista_declaraciones',2,'p_lista_declaraciones','sint.py',48),
  ('lista_declaraciones -> declaracion','lista_declaraciones',1,'p_lista_declaraciones','sint.py',49),
  ('declaracion -> declaracion_variable','declaracion',1,'p_declaracion','sint.py',57),
  ('declaracion -> lista_sentencias','declaracion',1,'p_declaracion','sint.py',58),
  ('declaracion -> comentario','declaracion',1,'p_declaracion','sint.py',59),
  ('comentario -> COMENTARIO','comentario',1,'p_comentario','sint.py',64),
  ('declaracion_variable -> tipo identificador SEMICOLON','declaracion_variable',3,'p_declaracion_variable','sint.py',69),
  ('identificador -> identificador COMMA IDENTIFICADOR','identificador',3,'p_identificador','sint.py',77),
  ('identificador -> IDENTIFICADOR','identificador',1,'p_identificador','sint.py',78),
  ('tipo -> INT','tipo',1,'p_tipo','sint.py',86),
  ('tipo -> DOUBLE','tipo',1,'p_tipo','sint.py',87),
  ('tipo -> INTEGER','tipo',1,'p_tipo','sint.py',88),
  ('tipo -> REAL','tipo',1,'p_tipo','sint.py',89),
  ('lista_sentencias -> lista_sentencias sentencia','lista_sentencias',2,'p_lista_sentencias','sint.py',94),
  ('lista_sentencias -> sentencia','lista_sentencias',1,'p_lista_sentencias','sint.py',95),
  ('lista_sentencias -> vacio','lista_sentencias',1,'p_lista_sentencias','sint.py',96),
  ('sentencia -> seleccion','sentencia',1,'p_sentencia','sint.py',106),
  ('sentencia -> iteracion','sentencia',1,'p_sentencia','sint.py',107),
  ('sentencia -> repeticion','sentencia',1,'p_sentencia','sint.py',108),
  ('sentencia -> entrada','sentencia',1,'p_sentencia','sint.py',109),
  ('sentencia -> salida','sentencia',1,'p_sentencia','sint.py',110),
  ('sentencia -> asignacion','sentencia',1,'p_sentencia','sint.py',111),
  ('sentencia -> incremento','sentencia',1,'p_sentencia','sint.py',112),
  ('sentencia -> decremento','sentencia',1,'p_sentencia','sint.py',113),
  ('asignacion -> IDENTIFICADOR ASSIGN p_expresion_finalizada','asignacion',3,'p_asignacion','sint.py',118),
  ('incremento -> IDENTIFICADOR INC SEMICOLON','incremento',3,'p_incremento','sint.py',124),
  ('decremento -> IDENTIFICADOR DEC SEMICOLON','decremento',3,'p_decremento','sint.py',130),
  ('p_expresion_finalizada -> expresion SEMICOLON','p_expresion_finalizada',2,'p_expresion_finalizada','sint.py',136),
  ('p_expresion_finalizada -> SEMICOLON','p_expresion_finalizada',1,'p_expresion_finalizada','sint.py',137),
  ('seleccion -> IF expresion THEN lista_sentencias END','seleccion',5,'p_seleccion','sint.py',145),
  ('seleccion -> IF expresion THEN lista_sentencias ELSE lista_sentencias END','seleccion',7,'p_seleccion','sint.py',146),
  ('iteracion -> WHILE expresion DO lista_sentencias END','iteracion',5,'p_iteracion','sint.py',155),
  ('repeticion -> DO lista_sentencias UNTIL expresion SEMICOLON','repeticion',5,'p_repeticion','sint.py',161),
  ('entrada -> CIN expresion SEMICOLON','entrada',3,'p_entrada','sint.py',167),
  ('salida -> COUT expresion SEMICOLON','salida',3,'p_salida','sint.py',173),
  ('expresion -> expresion AND expresion','expresion',3,'p_expresion','sint.py',179),
  ('expresion -> expresion OR expresion','expresion',3,'p_expresion','sint.py',180),
  ('expresion -> expresion_simple operacion_relacional expresion_simple','expresion',3,'p_expresion','sint.py',181),
  ('expresion -> expresion_simple','expresion',1,'p_expresion','sint.py',182),
  ('operacion_relacional -> MORETHAN','operacion_relacional',1,'p_operacion_relacional','sint.py',190),
  ('operacion_relacional -> LESSTHAN','operacion_relacional',1,'p_operacion_relacional','sint.py',191),
  ('operacion_relacional -> MOREEQUALS','operacion_relacional',1,'p_operacion_relacional','sint.py',192),
  ('operacion_relacional -> LESSEQUALS','operacion_relacional',1,'p_operacion_relacional','sint.py',193),
  ('operacion_relacional -> EQUALS','operacion_relacional',1,'p_operacion_relacional','sint.py',194),
  ('operacion_relacional -> NOTEQUALS','operacion_relacional',1,'p_operacion_relacional','sint.py',195),
  ('operacion_relacional -> AND','operacion_relacional',1,'p_operacion_relacional','sint.py',196),
  ('operacion_relacional -> OR','operacion_relacional',1,'p_operacion_relacional','sint.py',197),
  ('expresion_simple -> expresion_simple primer_operador term','expresion_simple',3,'p_expresion_simple','sint.py',202),
  ('expresion_simple -> term','expresion_simple',1,'p_expresion_simple','sint.py',203),
  ('primer_operador -> SUMA','primer_operador',1,'p_primer_operador','sint.py',211),
  ('primer_operador -> RESTA','primer_operador',1,'p_primer_operador','sint.py',212),
  ('term -> term segundo_operador factor','term',3,'p_term','sint.py',217),
  ('term -> factor','term',1,'p_term','sint.py',218),
  ('segundo_operador -> MULT','segundo_operador',1,'p_segundo_operador','sint.py',226),
  ('segundo_operador -> DIVIDE','segundo_operador',1,'p_segundo_operador','sint.py',227),
  ('segundo_operador -> MOD','segundo_operador',1,'p_segundo_operador','sint.py',228),
  ('factor -> factor tercer_operador componente','factor',3,'p_factor','sint.py',233),
  ('factor -> componente','factor',1,'p_factor','sint.py',234),
  ('tercer_operador -> POT','tercer_operador',1,'p_tercer_operador','sint.py',242),
  ('componente -> LPARENT expresion RPARENT','componente',3,'p_componente','sint.py',247),
  ('componente -> numero','componente',1,'p_componente','sint.py',248),
  ('componente -> IDENTIFICADOR','componente',1,'p_componente','sint.py',249),
  ('numero -> INT','numero',1,'p_numero','sint.py',259),
  ('numero -> DOUBLE','numero',1,'p_numero','sint.py',260),
  ('numero -> LPARENT RESTA INT RPARENT','numero',4,'p_numero','sint.py',261),
  ('numero -> LPARENT RESTA DOUBLE RPARENT','numero',4,'p_numero','sint.py',262),
  ('vacio -> <empty>','vacio',0,'p_vacio','sint.py',270),
]
